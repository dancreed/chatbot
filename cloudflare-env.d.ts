/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 3392a690c84d08f198c2669ad6d515c3)
// Runtime types generated with workerd@1.20250813.0 2025-08-13 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		MY_DURABLE_OBJECT: DurableObjectNamespace /* MyDurableObject from worker */;
		ASSETS: Fetcher;
	}
}
